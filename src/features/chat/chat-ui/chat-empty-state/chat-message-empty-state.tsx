...
export const ChatMessageEmptyState: FC<Prop> = (props) => {
  ...
  return (
    <div className="mt-12 sm:mt-0 sm:grid sm:grid-cols-5 w-full items-center container mx-auto max-w-3xl justify-center overflow-y-scroll h-full gap-9">
      <div className="col-span-2 gap-5 flex flex-col flex-1">
        <img src="/ai-icon.png" className="w-20 sm:w-36" />
        <p className="">
      ...
      <Card className="col-span-3 mt-10  flex flex-col gap-5 p-5 ">
